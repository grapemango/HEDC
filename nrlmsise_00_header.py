 ...
 *   16 - all TINF var(All exospheric temperature variations)
 *   17 - all TLB var(All variations from 120,000 meter temperature (TLB))
 *   18 - all TN1 var(All lower thermosphere (TN1) temperature variations)
 *   19 - all S var(All 120,000 meter gradient (S) variations)
 *   20 - all TN2 var(All upper stratosphere (TN2) temperature variations)
 *   21 - all NLB var(All variations from 120,000 meter values (ZLB))
 *   22 - all TN3 var(All lower mesosphere temperature (TN3) variations)
